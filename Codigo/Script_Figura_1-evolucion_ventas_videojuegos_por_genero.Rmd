...
\#Version 1 \#Para una siguiente version se estima hacer un grafico por genero, ya que al ser tantos datos, independiente de los colores que se elijan, no sera muy claro, luego se pueden superponer los mas similares para compararlos
